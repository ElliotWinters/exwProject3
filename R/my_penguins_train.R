#' A subset of the my_penguins data, including only bill_length_mm,
#' bill_depth_mm, flipper_length_mm, and body_mass_g. Two observations from
#' my_penguins were removed as these variables had NA entries.
#'
