#' A subset of the my_penguins data, including only the species variable, for
#' use in the my_knn_cv and my_rf_cv functions. Two observations were omitted,
#' where training data was absent for those observations.
#'
